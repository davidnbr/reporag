...
from rag_mcp.indexer import scip_indexer
from rag_mcp.indexer.heuristic_graph import extract_imports
...
def build_graph_for_project(
    ...
    from rag_mcp.indexer.ast_parser import detect_language
